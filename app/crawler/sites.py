...
class Xpaths:
    ...
    to_nedvizh: str = r"//a[(contains(@class, 'rubricator-list-') or contains(@class, 'js-catalog-counts__link')) and (contains(@title, 'Недвижимость'))]"
    ...
    to_category: str = r"//a[(contains(@class, 'rubricator-list-') or contains(@class, 'js-catalog-counts__link')) and (contains(@title, 'Недвижимость'))]//parent::div//parent::li/ul/li"
    ...
    to_buy_button: str = r"//div[contains(@class, 'radio-group-root_layout-horizontal')]//span[contains(text(), 'Купить')]"
    to_view_all_button: str = r"//button[contains(@data-marker, 'search-filters/submit-button')]"
    to_next_button: str = r"//span[contains(@data-marker,'pagination-button/next') and not(contains(@class, 'pagination-item_readonly'))]"
